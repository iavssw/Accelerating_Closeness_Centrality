...
#pragma HLS INTERFACE m_axi depth = 100000000 port = adj_mat0 offset = slave bundle = adj_port0
#pragma HLS INTERFACE m_axi depth = 100000000 port = adj_mat1 offset = slave bundle = adj_port1
#pragma HLS INTERFACE m_axi depth = 100000000 port = adj_mat2 offset = slave bundle = adj_port2
#pragma HLS INTERFACE m_axi depth = 100000000 port = adj_mat3 offset = slave bundle = adj_port3
