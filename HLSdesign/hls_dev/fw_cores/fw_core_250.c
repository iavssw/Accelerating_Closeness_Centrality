...
#pragma HLS array_partition variable = v2 cyclic factor = 10 dim = 2
    ...
    for (int v8 = 0; v8 < 50; v8 += 1) {                                         // L7
        for (int v9 = 0; v9 < 50; v9 += 1) {                                     // L7
            for (int v10 = 0; v10 < 25; v10 += 1) {                              // L7
#pragma HLS PIPELINE            
                for (int v11 = 0; v11 < 5; v11 += 1) {                           // L7
                    for (int v12 = 0; v12 < 5; v12 += 1) {                       // L7
                        for (int v13 = 0; v13 < 10; v13 += 1) {                  // L7
                            ...
                            unsigned short v17 = v1[(v12 + (v9 * 5))][(v11 + (v8 * 5))];  // L21
                            short v18 = v17 != 65535.000000;                      // L22
                            unsigned short v19;
                            if (v18) {                                                 // L23
                                unsigned short v20 = v2[(v11 + (v8 * 5))][(v13 + (v10 * 10))];  // L24
                                short v21 = v20 != 65535.000000;                        // L25
                                unsigned short v22;
                                if (v21) {                                                 // L26
                                    unsigned short v23 = v1[(v12 + (v9 * 5))][(v11 + (v8 * 5))];    // L27
                                    unsigned short v24 = v2[(v11 + (v8 * 5))][(v13 + (v10 * 10))];  // L28
                                    unsigned short v25 = v23 + v24;                                 // L29
                                    unsigned short v26 = v0[(v12 + (v9 * 5))][(v13 + (v10 * 10))];  // L30
                                    short v27 = v25 < v26;                                  // L31
                                    if (v27) {                                             // L32
                                        v0[(v12 + (v9 * 5))][(v13 + (v10 * 10))] = v25;    // L33
                                    }
                                    v22 = v25;  // L35
                                } else {
                                    v22 = v16;  // L37
